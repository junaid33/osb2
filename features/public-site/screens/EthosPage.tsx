                ...
                <HoverCard>
                  <div className="flex items-center gap-3">
                    <img
                      ...
                      src="https://avatars.githubusercontent.com/u/13262179?v=4"
                      width={40}
                      height={40}
                      alt="Avatar"
                    />
                    <div className="space-y-0">
                      <HoverCardTrigger asChild>
                        <p>
                          <a className="text-base font-medium hover:underline" href="https://github.com/junaid33">
                            Junaid
                          </a>
                        </p>
                      </HoverCardTrigger>
                      <p className="text-muted-foreground text-sm">@junaid33</p>
                    </div>
                  </div>
                  <HoverCardContent>
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="space-y-0.5">
                          ...
                          <p className="text-muted-foreground text-xs">@junaid33</p>
                        </div>
                      </div>
                      <p className="text-muted-foreground text-sm">
                        Founder and CEO of{" "}
                        <a href="https://github.com/openshiporg/openship" className="text-foreground font-medium hover:underline" target="_blank" rel="noopener noreferrer">
                          Openship
                        </a>
                        ,{" "}
                        <a href="https://github.com/openshiporg/openfront" className="text-foreground font-medium hover:underline" target="_blank" rel="noopener noreferrer">
                          Openfront
                        </a>
                        ,{" "}
                        <a href="https://github.com/junaid33/opensource.builders" className="text-foreground font-medium hover:underline" target="_blank" rel="noopener noreferrer">
                          Opensource.Builders
                        </a>
          ...
          <div className="max-w-2xl space-y-8" key="2025">
            ...
            <div>
              ...
              <TextScramble
                ...
                duration={1.2}
              >
                Opensource.Builders supports this by doing more than simply listing which applications offer certain features. We also track where in the code those features live. This gives AI the context it needs to learn from working examples and then generate similar functionality for your environment. This is the idea behind the Build Drawer. You select the features you want from existing projects, and we create a structured prompt you can feed to the AI system of your choice. The AI then has a clear guide to help you bring those features into your own project.
              </TextScramble>
            </div>
            ...
            <div>
              ...
              <TextScramble
                ...
                duration={1.2}
              >
                Opensource.Builders is the companion to that vision. Each Openfront we build can stand on its own, but with our feature tracking and Build Drawer, businesses can go further. For example, if you run a barbershop and also want to sell merchandise, you can take e-commerce features from the retail Openfront and add them to the barbershop Openfront. The result is a personal platform that reflects your business exactly as you need it.
              </TextScramble>
              <TextScramble
                as="p"
                className="text-muted-foreground leading-relaxed sm:text-lg font-medium"
          ...
          <div className="max-w-2xl space-y-8" key="2020">
            ...
            <div>
              ...
              <TextScramble
                ...
                duration={1.2}
              >
                Most times, a commercial option was available, but these developers had the creator's mentality: <strong>I can build it better</strong>. Being open-source further accelerated this since more people could look at the code and contribute to make it better.
              </TextScramble>
            </div>
