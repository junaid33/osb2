            ...
            >
              {pinned.map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-center size-8 rounded-full bg-primary flex-shrink-0">
                    <Pin className="size-4 text-primary-foreground fill-primary-foreground" />
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            >
              {unpinned.map((item) => (
                <motion.div
                  ...
                  onClick={() => toggleStatus(item.id)}
                  transition={transition}
                  className="flex items-center justify-between gap-5 rounded-2xl bg-background border p-2 group"
                >
                  <div className="flex items-center gap-2 flex-1 min-w-0">
                    <div className="rounded-lg bg-muted p-2 flex-shrink-0">
                      <item.icon className="size-5 text-muted-foreground" />
                  ...
                  <div className="flex items-center justify-center size-8 rounded-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-250 flex-shrink-0">
